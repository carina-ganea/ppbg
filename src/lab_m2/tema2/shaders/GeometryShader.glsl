...
void main()
{
    ...
    if (instance[0] <= no_of_instances)
    {
        ...
        //gl_Position = Projection * View * vec4(translateX(control_p1, instance[0]), 1);   EmitVertex();
        //gl_Position = Projection * View * vec4(translateX(control_p2, instance[0]), 1);   EmitVertex();
        //gl_Position = Projection * View * vec4(translateX(control_p3, instance[0]), 1);   EmitVertex();
        EndPrimitive();
